            ...
            <Dialog open={open} onOpenChange={setModal}>
                <DialogContent className="bg-gray-900 border-gray-800 rounded-2xl">
                    ...
                    <DialogFooter>
                        ...
                        <Button variant={'outline'} className="cursor-pointer bg-red-900 text-gray-900 rounded-2xl border-0 hover:bg-red-900/80 py-4.5" onClick={() => { onConfirm(); setModal(false) ; toast.custom(() => (
